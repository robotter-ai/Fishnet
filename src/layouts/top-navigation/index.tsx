...
import {BellIcon, LogoutIcon} from '@assets/icons';
...
function TopNavigation() {
  ...
  const { handleConnectWallet, handleDisconnectWallet } = useLogin();
    ...
    <div id="top-navigation">
      <div className="flex justify-between">
        ...
        {!hasValidToken || !walletConnected ? (
          ...
          <>
            <div ref={notificationRef} className="relative flex items-center gap-[15px]">
